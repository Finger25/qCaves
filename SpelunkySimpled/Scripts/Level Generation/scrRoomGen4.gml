...
else if (roomPath == 0 and rand(1,4) > 1) // side room
{
    ...
    else if (not global.altar and rand(1,12) == 1)
    {
        n = 16;
        global.altar = true;
    }
...
else if (roomPath == 4) // shop
{
    ...
    switch(n)
    {
        ...
        case 7: { shopType = "Kissing"; strTemp = "111111111111111111111111221111111p000211...000W010...00000k0..K00A0000bbbbbbbbbb"; global.damsel = true; break; }
    }   
}
else if (roomPath == 5) // shop
{
    ...
    switch(n)
    {
        ...
        case 7: { shopType = "Kissing"; strTemp = "111111111111111111111111221111112000p11101W0000...0k00000...0000A00K..bbbbbbbbbb"; global.damsel = true; break; }
    }
}
    ...
    for (i = 1; i < 11; i += 1)
    {
        ...
        else if (tile == "c")
        {
            if (rand(1,2) == 1) instance_create(xpos+8, ypos+8, oChest);
                ...
                instance_create(xpos+8, ypos+8, oCrate);
                global.totalCratesGen += 1;
            } 
        }
        else if (tile == "t")
        {

...
//ADDED BY ME
global.totalCratesGen = 0;
random_set_seed(global.customSeed);
//random_set_seed(1);
//show_message(string(rand(1,100)));
//show_message(string(rand(1,100)));
//show_message(string(rand(1,100)));
...
else if (global.currLevel > 8 and global.currLevel < 13) global.levelType = 2;
else if (global.currLevel > 12 and global.currLevel < 16) global.levelType = 3;
else if (global.currLevel == 16) global.levelType = 4;
...
// global.levelType = 0;
//show_message(string(rand(1,1000)));
global.startRoomX = 0;
global.startRoomY = 0;
global.endRoomX = 0;
global.endRoomY = 0;
...
if (global.levelType == 4)
    ...
    k = 38;
//else if (global.lake)//will be needed
    //k = 41;
else
    k = 33;
for (i = 0; i <= 42; i += 1)
{
    ...
    {
    /*
        if (not isLevel())//should be unneeded
        {
            i = 999;
            j = 999;
        }
...
if (global.levelType == 2)
{
    for (i = 0; i <= 42; i += 1)
    {
        ...
        //instance_create(i*16, 35*16, oSpikes);//not me
    }
}
...
/*
//just gives level feeling text, unneeded
...
//global.customSeed += 1; //ADDED BY ME
